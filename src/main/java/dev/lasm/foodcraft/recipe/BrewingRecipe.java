...
public class BrewingRecipe implements Recipe<FluidAttachedContainer> {
    ...
    public BrewingRecipe(ResourceLocation id, String group, ItemStack output,
        NonNullList<Ingredient> ingredients, @Nullable FluidStack fluidInput) {
        this.id = id;
        this.group = group;
        this.output = output;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getId(), that.getId()) && Objects.equals(getGroup(),
    ...
    public static class Serializer implements RecipeSerializer<BrewingRecipe> {
        ...
        @Override
        public @NotNull BrewingRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new BrewingRecipe(id, group, output, ingredients, fluidInput);
        }

        @Override
        public @Nullable BrewingRecipe fromNetwork(ResourceLocation id,
